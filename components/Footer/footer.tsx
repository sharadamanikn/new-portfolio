...
const Footer = () => {
  ...
  <div className="bg-gray-1000 border-t border-neutral-600 py-6 flex justify-center">
      <div className="w-[90%] md:w-3/4 lg:w-1/2 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex-grow text-center justify-center text-1xl text-gray-100 ">
          Made with ❤️ (Next.js) 
        </div>
    ...
    className="bg-blue-600  hover:shadow-[0_0_11px_rgba(59,130,246,0.6)]  text-white font-semibold flex items-center justify-center py-2 px-4 h-[40px] w-[90px] rounded-2xl transition duration-200"
  >
    Connect
  </a>
